...
public class Event_Page_Home_Creer_Etudiant implements ActionListener{

	private First_Window fenetre_principale;
	private User utilisateur;

	public Event_Page_Home_Creer_Etudiant(First_Window fenetre, 
			User utilisateur) {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (utilisateur.getType_user().equals("ADMIN")) {
			fenetre_principale.getCard_Layout_Panel_center_New_Etudiant();
		} else {
